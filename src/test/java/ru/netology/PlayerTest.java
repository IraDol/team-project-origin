...
public class PlayerTest {
    ...
    @Test
    public void shouldMostPlayerByGenre1() { // Возвращает название игры, в которую играли больше всего или null
        GameStore store = new GameStore();
        Game game = store.publishGame("Нетология Баттл Онлайн", "Аркады");
        Game game2 = store.publishGame("Нетология Баттл Онлайн2", "Аркады");
    ...
    @Test
    public void shouldInstallGame() { //Возвращает суммарное время игры при повторной установки игры.
        GameStore store = new GameStore();
        Game game = store.publishGame("Нетология Баттл Онлайн", "Аркады");
